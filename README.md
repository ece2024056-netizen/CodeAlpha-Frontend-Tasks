...
This folder contains four completed frontend projects for the CodeAlpha internship tasks.

## Projects

| Task | Folder | Main file |
| --- | --- | --- |
...
Open any project's `index.html` in a modern browser. No build tools or installation are required.
